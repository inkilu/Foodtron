                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">Your Orders</h2>
                                            <p class="m-b-0 text-muted">Enjoy!</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        ...
                                        <div class="m-l-15">
                                            <h2 class="m-b-0">Welcome,</h2>
                                            <p class="m-b-0 text-muted"><?php echo $_SESSION['sess'];?></p>
                                        </div>
                        ...
                        <div class="m-t-25">
                            <table id="data-table" class="table">
                                ...
                                <tbody>
                                    ...
                                    $chk = $_SESSION['sess'];
                                    $records = mysqli_query($conn, "SELECT * FROM orders WHERE fname='$chk'");
                            ...
                            <p align="center">ETA : 1 Hr (Max)</p> <br>
                            <p align="center">Our Delivery Agent Will Contact You Soon!</p>
                        </div>
                    </div>
                </div>
                <!-- Content Wrapper END -->
